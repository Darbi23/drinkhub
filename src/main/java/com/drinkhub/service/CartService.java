...
public class CartService {
    ...
    public CartDto updateCartItem(Long userId, CartItemDto cartItemDto) {
        CartItem cartItem = cartItemRepository.findById(cartItemDto.id())
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Cart item not found with id: " + cartItemDto.id()));
